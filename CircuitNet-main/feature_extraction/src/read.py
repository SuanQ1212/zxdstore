...
class ReadInnovusOutput:
    def __init__(self, root_dir, arg, save_name, lef_dict, lef_dict_jnet=None):
        ...
        self.route_def_path = "/home/eda/lcj/new-test/CircuitNet-main/feature_extraction/data/ispd19_test3.input.def"
        ...
        self.drc_path = "/home/eda/lcj/new-test/CircuitNet-main/feature_extraction/drc/ispd19_test3.drc.rpt"    
        ...
        with open(self.drc_path, 'r') as read_file:
            for line in read_file:
                if "Net" in line or "Cell" in line:
                    ...
                    #print(float(drc_area[0])*self.unit, float(drc_area[1])*self.unit, float(drc_area[2])*self.unit, float(drc_area[3])*self.unit)
                    # print(drc_area)
    ...
    def compute_DRC_density(self):
        drc_density_dict = {}
        overall_count = 0
        #print(f"gcell_size{self.gcell_size}")
